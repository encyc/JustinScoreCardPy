...
#plot_learning_curve(LogisticRegression(max_iter=100000),df[col],df['dlq_flag'],cv = 10, train_size = [0.1, 0.25, 0.5, 0.75, 1],plt_size = (10,10))
#cross_verify(df[col],df['dlq_flag'],LogisticRegression(max_iter= 10000),10)
